          ...
          : (
            <div className="">
                ...
                <div className="w-full h-54 items-center relative">
                  <button className="bg-green-400 hover:bg-green-500 text-lg p-1 absolute z-40 -right-7 top-28">Previous</button>
                  <button className="bg-green-400 hover:bg-green-500 text-lg p-1 absolute z-40 -right-7 top-28">Next</button>
                </div>
